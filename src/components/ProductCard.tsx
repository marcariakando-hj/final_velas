    ...
    >
      ...
      <div className="px-5 py-3.5 bg-[#FAF7F2] border-t border-[#E5E0DA] flex items-center justify-between text-xs">
        ...
        <button
          ...
          className="px-3.5 py-1.5 rounded-full bg-[#4A4541] hover:bg-[#35312E] text-white text-[10px] uppercase tracking-widest font-bold flex items-center gap-1.5 cursor-pointer shadow-2xs hover:shadow-xs transition-all"
