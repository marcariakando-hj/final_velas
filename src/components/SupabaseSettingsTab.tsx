...
-- 4. Políticas de Acceso para Productos (Permite lectura y edición con anon key)
...
-- 5. Políticas de Acceso para Configuraciones
...
-- 6. Bucket de Almacenamiento para Imágenes (candle-assets)
INSERT INTO storage.buckets (id, name, public)
VALUES ('candle-assets', 'candle-assets', true)
ON CONFLICT (id) DO NOTHING;

-- 7. Políticas de Acceso para Storage
